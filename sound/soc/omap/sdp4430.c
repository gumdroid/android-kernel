...
static int sdp4430_twl6040_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	if (machine_is_omap_4430sdp() || machine_is_omap4_panda() || machine_is_omap4_duovero())
...
static int __init sdp4430_soc_init(void)
{
	...
	if (!machine_is_omap_4430sdp() && !machine_is_omap4_panda() && !machine_is_omap4_duovero()) {
		pr_debug("Not SDP4430, PandaBoard or Duovero!\n");
		return -ENODEV;
	}
	...
	else if (machine_is_omap4_duovero())
		snd_soc_sdp4430.name = "Duovero";
